...
(function (Y, O, r) {
  ...
  function q(b, a, c) {
    ...
    if (b)
      ...
      else if (ob(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
  ...
  function Sb() {
    return (
      (O.securityPolicy && O.securityPolicy.isActive) ||
      (O.querySelector &&
        !(!O.querySelector("[ng-csp]") && !O.querySelector("[data-ng-csp]")))
    );
  }
  function qb(b, a) {
    var c = 2 < arguments.length ? ua.call(arguments, 2) : [];
    return !J(a) || a instanceof RegExp
      ? a
      : c.length
      ? function () {
  ...
  function fc(b) {
    ...
    "function" == typeof b
      ? (a = b.$inject) ||
        ...
        (b.$inject = a))
      : I(b)
      ? ((c = b.length - 1), Oa(b[c], "fn"), (a = b.slice(0, c)))
      : Oa(b, "fn", !0);
    return a;
  }
  function Yb(b) {
          ...
          try {
            ...
            throw (
              ...
              m.message &&
                ...
                (m = m.message + "\n" + m.stack),
              Sa("modulerr", a, m.stack || m.message || m))
            );
          }
        }
      });
    ...
    h.cookies = function (a, b) {
      ...
      if (a)
        b === r
          ...
          : E(b) &&
            ((d =
              (l.cookie = escape(a) + "=" + escape(b) + ";path=" + Q).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
          ...
          for (
            ...
            (e = d[g]),
              ...
              0 < h &&
                ...
                W[a] === r && (W[a] = unescape(e.substring(h + 1))));
        return W;
      }
    };
      ...
      function (a, b, m, n, p, t, w, A, F, H, S, z) {
        ...
        function M(a, b, c, d, e, g) {
          function f(a, c, d, e) {
            ...
            w = n = 0;
            for (t = k.length; n < t; w++)
              (l = K[w]),
                (c = k[n++]),
                (g = k[n++]),
                (m = u(l)),
                c
                  ? (c.scope ? ((p = a.$new()), m.data("$scope", p)) : (p = a),
                    (m = c.transclude) || (!e && b)
                      ? c(g, p, l, d, W(a, m || b))
                      : c(g, p, l, d, e))
                  : g && g(a, l.childNodes, r, e);
          }
          for (var k = [], l, m, p, n, t = 0; t < a.length; t++)
            (l = new Db()),
              (m = ka(a[t], [], l, 0 === t ? d : r, e)),
              (g = m.length ? ga(m, a[t], l, b, c, null, [], [], g) : null) &&
                g.scope &&
                $(u(a[t]), "ng-scope"),
              (l =
                (g && g.terminal) || !(p = a[t].childNodes) || !p.length
                  ? null
                  : M(p, g ? g.transclude : b)),
              k.push(g, l),
              (n = n || g || l),
              (g = null);
          return n ? f : null;
            ...
            case 8:
              try {
                if ((l = e.exec(a.nodeValue)))
                  (n = la(l[1])), T(b, n, "M", d, f) && (c[n] = aa(l[2]));
              } catch (W) {}
          }
          b.sort(D);
          return b;
        ...
        function ga(a, c, d, e, g, f, l, p, n) {
          ...
          function W(a, e, g, f, n) {
            ...
            if (z) {
              ...
              f = u(g);
              Q = e.$new(!0);
              ga && ga === z.$$originalDirective
                ? f.data("$isolateScope", Q)
                : f.data("$isolateScopeNoTemplate", Q);
              $(f, "ng-isolate-scope");
          ...
          for (
            ...
            if ((s = G.scope))
              (M = M || G),
                G.templateUrl ||
                  (C("new/isolated scope", z, G, x), V(s) && (z = G));
            ba = G.name;
            !G.templateUrl &&
              G.controller &&
              ((s = G.controller),
              (H = H || {}),
              C("'" + ba + "' controller", H[ba], G, x),
              (H[ba] = G));
            if ((s = G.transclude))
              (T = !0),
                G.$$tlb || (C("transclusion", n, G, x), (n = G)),
                "element" == s
                  ? ((D = !0),
                    (F = G.priority),
                    (s = Q(c, P, U)),
                    (x = d.$$element =
                      u(O.createComment(" " + ba + ": " + d[ba] + " "))),
                    (c = x[0]),
                    fb(g, u(ua.call(s, 0)), c),
                    (N = B(s, e, F, f && f.name, {
            ...
            if (G.template)
              if (
                (C("template", ga, G, x),
                (ga = G),
                (s = J(G.template) ? G.template(x, d) : G.template),
                (s = X(s)),
                G.replace)
              ) {
                f = G;
            ...
            if (G.templateUrl)
              C("template", ga, G, x),
                (ga = G),
                G.replace && (f = G),
                (W = y(a.splice(L, a.length - L), x, d, g, N, l, p, {
              ...
              try {
                (ma = G.compile(x, d, N)),
                  J(ma) ? A(null, ma, P, U) : ma && A(ma.pre, ma.post, P, U);
              } catch (Z) {
                m(Z, fa(x));
              }
        ...
        function y(a, b, c, d, e, g, f, l) {
          ...
          b.empty();
          n.get(H.getTrustedResourceUrl(S), { cache: p })
            .success(function (p) {
              var n, F;
              p = X(p);
              if (A.replace) {
        ...
        function fb(a, b, c) {
          ...
          for (e = b.length; d < e; d++)
            (g = b[d]), u(g).remove(), a.appendChild(g), delete b[d];
          b[0] = c;
          b.length = 1;
        }
        function ic(a, b) {
        ...
        return function (e, g) {
          ...
          E(e) &&
            ...
            (e = b.hasOwnProperty(h)
              ? b[h]
              : tb(g.$scope, h, !0) || tb(d, h, !0)),
            Oa(e, h, !0));
          f = c.instantiate(e, g);
          if (l) {
            if (!g || "object" != typeof g.$scope)
              throw s("$controller")("noscp", h || e.name, l);
            g.$scope[l] = f;
          }
          return f;
        };
      ...
      function (a, b, c, d, n, p) {
        ...
        function w(b, c, g) {
          ...
          (b.cache || e.cache) &&
            !1 !== b.cache &&
            "GET" == b.method &&
            (q = V(b.cache) ? b.cache : V(e.cache) ? e.cache : F);
          if (q)
            if (((H = q.get(r)), v(H))) {
  ...
  function md(b, a, c, d, e) {
    ...
    return function (e, l, k, m, n, p, t, w) {
      ...
      if ("jsonp" == C(e)) {
        ...
        var z = g(
          l.replace("JSON_CALLBACK", "angular.callbacks." + S),
          function () {
        ...
        B.onreadystatechange = function () {
          if (4 == B.readyState) {
            ...
            H !== f &&
              ...
              (b = B.responseType ? B.response : B.responseText));
            F(m, H || B.status, b, a);
          }
        };
  ...
  function od() {
    ...
    this.$get = [
      ...
      function (c, d, e) {
        function g(g, k, m) {
          for (var n, p, t = 0, w = [], A = g.length, F = !1, q = []; t < A; )
            -1 != (n = g.indexOf(b, t)) && -1 != (p = g.indexOf(a, n + f))
              ? (t != n && w.push(g.substring(t, n)),
                w.push((t = c((F = g.substring(n + f, p))))),
                (t.exp = F),
                (t = p + h),
                (F = !0))
              : (t != A && w.push(g.substring(t)), (t = A));
      ...
      function (c, d, e, g) {
        ...
        g.on("click", function (a) {
          if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
            for (var b = u(a.target); "a" !== C(b[0].nodeName); )
  ...
  function Ed() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = P(
            (/android (\d+)/.exec(C((b.navigator || {}).userAgent)) || [])[1]
          ),
        ...
        if (k) {
          ...
          !d ||
            (m && n) ||
            ((m = E(g.body.style.webkitTransition)),
            (n = E(g.body.style.webkitAnimation)));
        }
        return {
      ...
      c = Pc(c, function (a) {
        ...
        return e(function (a, b) {
          ...
          var e = d(b),
            ...
            f = typeof e;
          g == f
            ? ("string" == g && ((c = c.toLowerCase()), (e = e.toLowerCase())),
              (c = c === e ? 0 : c < e ? -1 : 1))
            : (c = g < f ? -1 : 1);
          return c;
        }, c);
  ...
  isNaN(L) &&
    (L = P((/trident\/.*; rv:(\d+)/.exec(C(navigator.userAgent)) || [])[1]));
  y.$inject = [];
  za.$inject = [];
  var aa = (function () {
  ...
  var Sc = /[A-Z]/g,
    ...
    Wc = 1,
    Hc = Y.document.addEventListener
      ? function (b, a, c) {
    ...
    zb = Y.document.removeEventListener
      ? function (b, a, c) {
    ...
    Da = (N.prototype = {
      ready: function (b) {
        ...
        "complete" === O.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), N(Y).on("load", a));
      },
      toString: function () {
        var b = [];
        q(this, function (a) {
  ...
  q(
    {
      ...
      scope: function (b) {
        return (
          u(b).data("$scope") ||
          cb(b.parentNode || b, ["$isolateScope", "$scope"])
        );
      },
      isolateScope: function (b) {
        return (
          u(b).data("$isolateScope") || u(b).data("$isolateScopeNoTemplate")
        );
      },
      controller: bc,
      injector: function (b) {
        ...
        q(d.split(" "), function (d) {
          ...
          if (!g) {
            if ("mouseenter" == d || "mouseleave" == d) {
              var m =
                O.body.contains || O.body.compareDocumentPosition
                  ? function (a, c) {
  ...
  Wa.prototype = {
    ...
    unary: function () {
      ...
      return this.expect("+")
        ? this.primary()
        : (a = this.expect("-"))
        ? this.binaryFn(Wa.ZERO, a.fn, this.unary())
        : (a = this.expect("!"))
  ...
  var Vd = Z({
      ...
      compile: function (a, c) {
        8 >= L &&
          ...
          a.append(O.createComment("IE fix")));
        if (!c.href && !c.name)
          return function (a, c) {
      ...
      function (a, c) {
        ...
        return {
          ...
          link: function (e, g, f) {
            ...
            q(f, function (a, c) {
              r.test(c) &&
                (m[C(c.replace("when", "").replace("Minus", "-"))] = g.attr(
                  f.$attr[c]
                ));
            });
            q(m, function (a, e) {
          ...
          link: function (e, g, f, h, l) {
            ...
            e.$watchCollection(h, function (a) {
              ...
              if (ob(a)) (T = a), (n = p || t);
                ...
                T = [];
                for (E in a)
                  a.hasOwnProperty(E) && "$" != E.charAt(0) && T.push(E);
                T.sort();
              }
              H = T.length;
              h = I.length = T.length;
          ...
          link: function (e, f, h, l) {
            ...
            function n(e, f, g) {
              function h() {
                ...
                if (t)
                  if (u && I(s))
                    for (r = new Ra([]), z = 0; z < s.length; z++)
                      (K[m] = s[z]), r.put(u(e, K), s[z]);
                  else r = new Ra(s);
                for (z = 0; (D = B.length), z < D; z++) {
                  ...
                  t
                    ? (d = v(r.remove(u ? u(e, K) : q(e, K))))
                    : (u
                        ? ((d = {}), (d[m] = s), (d = u(e, d) === u(e, K)))
                        : (d = s === q(e, K)),
                      (r = r || d));
                  F = l(e, K);
                  F = v(F) ? F : "";
                ...
                for (B = c.length; K < B; K++) {
                  ...
                  for (D = k.length; z < D; z++)
                    (r = k[z]),
                      (d = w[z + 1])
                        ? ((F = d.element),
                          d.label !== r.label && F.text((d.label = r.label)),
                          d.id !== r.id && F.val((d.id = r.id)),
                          F[0].selected !== r.selected &&
                            F.prop("selected", (d.selected = r.selected)))
                        : ("" === r.id && A
                            ? (J = A)
                            : (J = C.clone())
                                .val(r.id)
                          ...
                          F ? F.after(J) : s.element.append(J),
                          (F = J));
